...
MEMORY_BANK_ID = os.environ.get("MEMORY_BANK_ID", "5496345927310376960")
MEMORY_BANK_PROJECT = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-04-d2bb10d8ba5b")
MEMORY_BANK_LOCATION = os.environ.get("MEMORY_BANK_LOCATION", "us-central1")
